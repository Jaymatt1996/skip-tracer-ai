...
st.markdown("Upload your Excel file with names and addresses. This assistant will help you find contact info, deceased status, and executor or relatives if applicable.")
...
def real_skip_trace(name, city=None, state=None):
    ...
    if resp.status_code == 200:
        ...
        return {
            ...
            "Phone": data.get("phone_numbers", ["N/A"])[0],
            "Email": data.get("emails", ["N/A"])[0],
